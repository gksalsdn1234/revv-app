...
void main() {
  ...
  test(
    'resolveRunReviewSummary picks route replay as primary action when route exists',
    () {
      ...
      expect(summary.topStats, contains('62'));
      expect(summary.topStats, isNot(contains('120')));
    },
  );

  test(
    'resolveRunReviewSummary falls back to history when route is missing',
    () {
      final session = RunSession(
        startTime: DateTime.parse('2026-04-01T10:00:00Z'),
