...
class RevvRoute {
  ...
  double get maxElevationM => elevationProfile?.reduce(math.max) ?? 0;

  double get minElevationM => elevationProfile?.reduce(math.min) ?? 0;
  ...
  RevvRoute copyWith({
    ...
    return RevvRoute(
      ...
      roadNames: roadNames ?? this.roadNames,
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (roadNames.isNotEmpty) 'roadNames': roadNames,
  ...
  factory RevvRoute.fromJson(Map<String, dynamic> j) => RevvRoute(
    ...
    roadNames: ((j['roadNames'] as List?) ?? const [])
        .map((e) => e.toString())
        .where((e) => e.trim().isNotEmpty)
        .toList(),
    surfaceSummary: j['surfaceSummary'] as String? ?? '',
    speedLimitSummary: j['speedLimitSummary'] as String? ?? '',
  ...
  static List<RevvRoute> listFromJson(String raw) {
    ...
    return list
        .map((e) => RevvRoute.fromJson(e as Map<String, dynamic>))
        .toList();
  }
