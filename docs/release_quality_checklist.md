...
- `assets/sounds/beep.mp3` = myinstants F1 라디오 클립(F1 방송 원본, 상업 라이선스 없음). 개인 테스트 전용.
- 제출 전 **오리지널 합성음 교체(commit b8abd21 참고)** 또는 chirp 제거(`BeepWalkieChirp`). 상세: `assets/sounds/README_RELEASE_BLOCKER.txt`
